      ...
      <div class="row tabcontent">
        ...
        <div class="row table-content">
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
            <input type="text" name="name" class="from form-control" value="{{$playlist->name}}">
              @if($errors->any())
                <div class="error">    
                  {{$errors->first()}}
                </div>
...
<div class="filenew">
  ...
  @endforeach
          ...
          <input type="number" class="form-control" name="slidechangetime" value="{{$playlist->slidechangetime}}"> 
          </div>
              <!-----/----step3--------->
      </div>
       <!---------paginationrow--------->
