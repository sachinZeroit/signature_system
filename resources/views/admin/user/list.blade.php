...
@section('content')
  ...
  <div class="card-header">
    ...
    <a href="http://127.0.0.1:8000/admin/user/add" ><button type="button" class="addnew">Add New Users</button></a>
  </div>

  <div class="head">
    <div class="tab">
      <button class="tablinks" onclick="openCity(event, 'Paris')" id="defaultOpen" active>Admin</button>
            ...
            <table id="example2" class="table">
              ...
              <tbody>
                ...
                @foreach($admin as $vl)
                  ...
                  <tr>
                    <td>{{ $count }}</td>
                    <td><img src="{{$vl->image}}" width=100 height=100></td>
                    <td>{{ $vl->name }}</td>
                    <td>{{ $vl->full_name }}</td>
                    <td>{{ $vl->email }}</td>
                    <td>{{ $vl->role }}</td>
                    ...
                    <td class="action-icon">
                      <a href="{{route('admin.user.edit',$vl->id )}}" >
                      ...
                      <a href="{{route('admin.user.delete',$vl->id )}}">
