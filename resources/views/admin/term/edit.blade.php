...
<h3 class="card-title">Term Condition</h3>
...
<form method="post" action="<?=route('admin.term.update',$term->id);?>" enctype="multipart/form-data">
@csrf
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="content" class="form-control" value="{{$term->content}}">
  </div>
